                ...
                <div class="container">
                                    ...
                                    <table class='table table-bordered table-hover' id='myTable' style='width:100%;' align="center">
                                        ...
                                        <tbody>
                                            <?php
                                                    ...
                                                    $strSql = "SELECT DISTINCT pd_sbu, upload_date, upload_by, basic_start_date, count('pd ord no') as 'qty' " ;
                                            ...
                                            ?>                        
                                                            <tr>
                                                                ...
                                                                <td class='text-center'>
                                                                    <a href="pCOOIS_List.php?mode=1&sbu=<?php echo $user_sbu;?>&basic_start_date=<?php echo $ds['basic_start_date'];?>" >
                                ...
                                <div class='table-responsive'>
                                    <table class='table table-bordered table-hover' id='myTable' style='width:100%;' align="center">
                                        <thead> 
                                            <tr class='info'>
                                                <th class='text-center'>Basic Start Date</th>
                                                <th class='text-center'># Remaining Trans.</th>
                                                <th class='text-center'>Mode</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php
                                                    ...
                                                    /*------------------------------*/
                                                    include_once('include/db_Conn.php');
                                                    $strSql = "SELECT `Basic start date`, count(*) as 'qty' " ;
                                            ...
                                            ?>                        
                                                            <tr>
                                                                ...
                                                                <td class='text-center'><?php echo $ds['qty']; ?></td>
                                                                <td class='text-center'>
                                                                    <!--<a href="pCOOIS_List.php?basic_start_date=<?php //echo $ds['Basic start date'];?>" target='_blank'>-->
                                                                    <a href="pCOOIS_List.php?mode=2&sbu=<?php echo $user_sbu;?>&basic_start_date=<?php echo $ds['Basic start date'];?>" >
                                                                        <span class='fa fa-list fa-lg'></span>
                                                                    </a>
                                                                </td>                                                            
                                                            </tr>
                    ...
                    <div class="row">
                        <div class="col-lg-7">
                            ...
                            <div class="panel panel-seagreen">
                                <div class="panel-header" style="text-align:center;">
                                    <h3><span>Comparison production quantity by month [Plan /Actual]</span></h3>
                                    <div class="clearfix"></div>
                                </div>
                        ...
                        <div class="col-lg-5">
                            ...
                            <div class="panel panel-seagreen">
                                <div class="panel-header" style="text-align:center;">
                                    <h3><span>Act. prod. qty by pd. group [<?php echo date('M/Y');?>]</span></h3>
                                    <div class="clearfix"></div>
                                </div>
                                ...
                                <div class="panel-body">
                                    ...
                                    ?>
                                    <canvas id="barChart2" height="218px"></canvas>
                                </div>
                                <!-- /.box-body -->
                            </div>
                            <!-- /.box -->
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="panel panel-seagreen">
                                <div class="panel-header" style="text-align:center;">
                                    <h3><span>Capacity by reactor [<?php echo date('Y');?>]</span></h3>
                                    <div class="clearfix"></div>
                                </div>
