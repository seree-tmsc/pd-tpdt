                        ...
                        $('.edit_pdsch_data').click(function(){
                            ...
                            $.ajax({
                                ...
                                success: function(data)
                                {
                                    ...
                                    $('#actualStartTime').val(data['Actual start time']);

                                    $('#actualFinishDate').val(data['Actual finish date']);
                                    $('#actualFinishTime').val(data['Actual finish time']);
                                    
                                    $('#revactualFinishDate').val(data['Actual finish date']);
                                    $('#revactualFinishTime').val(data['Actual finish time']);
